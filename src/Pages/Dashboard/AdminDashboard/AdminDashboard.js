      ...
      <div className="dashboard-card">
        ...
        <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
          <div className="dashboard-logo">
            ...
            <p className="logo-name">READIFY!</p>
          </div>
          <p
          ...
          <p className={`dashboard-option ${active === "addcategory" ? "clicked" : ""}`} onClick={() => { setActive("addcategory"); setSidebar(false) }}><LibraryBooksIcon className='dashboard-option-icon' /> Add Category</p>
